...
const assertions = [
  ...
  ['tree contains replace children done', treeText.includes('1.1. 任务A1 [done]') && treeText.includes('1.2. 任务A2 [done]')],
  ['tree contains suspend children done', treeText.includes('2.1. 任务B1 [done]') && treeText.includes('2.2. 任务B2 [done]')],
